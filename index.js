...
const client = new Client({
  phoneNumber: '967782908846', // Bot number
  prefix: [".", "/", "!"],
  fromMe: false, 
  owners: [
  // Owner 1
    { name: "ايزن", lid: "421035007117585@lid", jid: "96778169314@s.whatsapp.net" },
  // Owner 2
    { name: "emam", lid: "221307316789354@lid", jid: "96778169314@s.whatsapp.net" },
  // Owner 3
